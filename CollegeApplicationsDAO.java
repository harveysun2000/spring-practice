...
@Repository
public class CollegeApplicationsDAO {
	...
	*/
	...
	public List<Score> getScoresByStudentName(String studentName) throws DataAccessException{
	...
	private class ScoreExtractor implements ResultSetExtractor<List<Score>> {
		@Override
		public List<Score> extractData(ResultSet rs) throws SQLException {
			BeanPropertyRowMapper<Score> scoreMapper = new BeanPropertyRowMapper<Score>(Score.class);
